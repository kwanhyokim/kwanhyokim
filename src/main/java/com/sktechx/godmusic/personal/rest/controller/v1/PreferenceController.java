...
public class PreferenceController {
    ...
    @ApiOperation(value = "장르 추천", httpMethod = "GET", notes = "선호 장르 추천 API", response = Genre.class)
    @GetMapping(value = "/geners")
    public CommonApiResponse<List<Genre>> preferencesGeners(@ApiIgnore @RequestGMContext GMContext ctx) {
    ...
    @ApiOperation(value = "장르 추천 상세", httpMethod = "GET", notes = "선호 장르 추천별 플레이 리스트 API", response = Genre.class)
    @GetMapping(value = "/geners/{chartId}")
    public CommonApiResponse<ChnlDto> preferencesGeners(@PathVariable("chartId") Long chartId) {
        log.info("GMContext : {}", GMContext.getContext());
