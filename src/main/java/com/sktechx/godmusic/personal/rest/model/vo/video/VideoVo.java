...
public class VideoVo {
    ...
    @Getter
    public static class VideoArtistVo {
        /**
         * 아티스트 ID
         */
        ...
        @Builder
        public VideoArtistVo(Long id, String name) {
            this.id = id;
            this.name = name;
        }
    }
    ...
    public static VideoVo mock() {
        ...
        VideoVo mock = VideoVo.builder()
                ...
                .representativeArtists(Lists.newArrayList(VideoArtistVo.builder().id(100L).name("Daniel").build()))
                .thumbnails(Lists.newArrayList(ThumbnailImageVo.builder().height(100).url("https://i.ytimg.com/vi/m8MfJg68oCs/hqdefault.jpg").build()))
