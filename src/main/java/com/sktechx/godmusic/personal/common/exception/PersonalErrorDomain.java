...
public enum PersonalErrorDomain implements ErrorDomain {
	...
	, CHANNEL_DUPLICATED_LIKE(4090704, HttpStatus.CONFLICT, "이미 추가된 채널 입니다.","중복된 채널")
	, CHANNEL_OVER_ADD_LIKE(4090705,HttpStatus.CONFLICT,"좋아요 한 플레이리스트를 더 이상 추가할 수 없습니다. 최대 1000개까지 담을 수 있습니다.","좋아하는 채널 최대값 초과")
	...
	, CHART_DUPLICATED_LIKE(4090710, HttpStatus.CONFLICT, "이미 추가된 차트 입니다." ,"이미 추가된 차트")
	, CHART_OVER_ADD_LIKE(4090711, HttpStatus.CONFLICT, "좋아요 한 차트을 더 이상 추가할 수 없습니다. 최대 1000개까지 담을 수 있습니다." ,"좋아하는 차트 최대값 초과")
	, MY_CHANNEL_OVER_CREATE(4090712, HttpStatus.CONFLICT,"my플레이리스트를 더 이상 추가할 수 없습니다.\n최대 1000개의 my플레이리스트를 만들 수 있습니다.","My 플레이 리스트 생성 최대값 초과")
	, MY_CHANNEL_TRACK_OVER_ADD(4090713, HttpStatus.CONFLICT, "my플레이리스트에는 최대 1000곡까지 담을 수 있습니다.\n새로운 플레이리스트를 만들어 주세요.","My 플레이 리스트 곡 추가 최대값 초과")
	, MY_CHANNEL_DUPLICATED_NAME(4090714, HttpStatus.CONFLICT, "동일한 my플레이리스트 명이 이미 존재합니다" ,"채널명 중복")
