...
public class RedisKeyConstant {
	...
	// 홈 선호 아티스트 최신 영상
	public static final String PERSONAL_PREFERNCE_VIDEO_ARTIST_NEW_LIST="godmusic.personalapi.preference.video.artist.new.list:%s";

	// 홈 선호 장르 최신 영상
	public static final String PERSONAL_PREFERNCE_VIDEO_GENRE_NEW_LIST="godmusic.personalapi.preference.video.genre.new.list:%s";
